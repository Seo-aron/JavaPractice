...
public class SynchronizedSar44 {
...
class SharedPrinter{ // 두개의 스레드(WorkerThread)에 의해 동시 접근되는 공유 프린터
	// synchronized를 생략하면 한글과 영어가 한 줄에 섞여 출력되는 경우 발생
	synchronized void print(String text) {
		// Thread.yield(); // 실행 시 많은 충돌 발생
...
class WorkerThread extends Thread{ // 스레드 클래스
	...
	// 스레드는 반복적으로 공유 프린터에 10번 접근하여 text[]를 출력
	public void run() {
